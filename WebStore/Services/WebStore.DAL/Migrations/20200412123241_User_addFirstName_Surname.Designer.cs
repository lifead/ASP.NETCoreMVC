...
namespace WebStore.DAL.Migrations
{
    ...
    [Migration("20200412123241_User_addFirstName_Surname")]
    partial class User_addFirstName_Surname
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebStore.Domain.Entities.Products.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebStore.Domain.Entities.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebStore.Domain.Entities.Products.Section", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebStore.Domain.Entities.Orders.OrderItem", b =>
                {
                    ...
                    b.HasOne("WebStore.Domain.Entities.Products.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("WebStore.Domain.Entities.Products.Product", b =>
                {
                    b.HasOne("WebStore.Domain.Entities.Products.Brand", "Brand")
                        .WithMany("Products")
                        .HasForeignKey("BrandId");

                    b.HasOne("WebStore.Domain.Entities.Products.Section", "Section")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("WebStore.Domain.Entities.Products.Section", b =>
                {
                    b.HasOne("WebStore.Domain.Entities.Products.Section", "ParentSection")
                        .WithMany()
